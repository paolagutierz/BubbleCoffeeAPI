...
public interface ProductoApi {
    ...
    @ApiOperation(value = "Agregar nuevo producto al Menu", nickname = "createProduct", notes = "Añadir producto al menu por medio de formulario", response = ProductoDTO.class, responseContainer = "List", tags = {"Producto",})
    @ApiResponses(value = {
    ...
    ResponseEntity<ProductoDTO> createProduct(@ApiParam(value = "Crear nuevo producto") @Valid @RequestBody ProductoDTO productoDTOItem);
    ...
    ResponseEntity<List<ProductoDTO>> findProductByCategory(@NotNull @ApiParam(value = "Ver productos por categoria", required = true, allowableValues = "cafes, bebidas, panaderia") @Valid @RequestParam(value = "category", required = true) String category);


    @ApiOperation(value = "Obtener todos los productos", nickname = "getProducts", notes = "Retorna todos los productos", response = ProductoDTO.class, tags = {"Producto",})
    @ApiResponses(value = {
    ...
    @RequestMapping(value = "/producto/all",
            produces = {"application/json"},
            method = RequestMethod.GET)
    ResponseEntity<List<ProductoDTO>> getProducts();
    ...
    @ApiOperation(value = "Eliminar producto del menu", nickname = "productoProductIdDelete", notes = "Eliminar producto del menu", response = ProductoDTO.class, tags = {"Producto",})
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "pedido eliminado", response = ProductoDTO.class),
            @ApiResponse(code = 404, message = "no encontrado")})
    @RequestMapping(value = "/producto/{productId}",
            method = RequestMethod.DELETE)
    ResponseEntity<ProductoDTO> productoProductIdDelete(@ApiParam(value = "eliminar producto", required = true) @PathVariable("productId") String productId);
    ...
    ResponseEntity<ProductoDTO> productoProductIdPut(@ApiParam(value = "cambiar o actualizar producto por id", required = true) @PathVariable("productId") String productId, @ApiParam(value = "producto a actualizar") @Valid @RequestBody ProductoDTO productoDTO);

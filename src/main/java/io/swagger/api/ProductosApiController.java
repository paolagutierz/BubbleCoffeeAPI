...
public class ProductosApiController implements ProductosApi {
    ...
    private static final Logger log = LoggerFactory.getLogger(ProductosApiController.class);
    ...
    public ProductosApiController(ObjectMapper objectMapper, HttpServletRequest request) {
